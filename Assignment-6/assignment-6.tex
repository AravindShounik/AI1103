...
\end{table}
\section*{Solution}
The mean of the distribution $(\overline{x})$ is given as
\begin{align}
    \overline{x}&= \sum_{i=1}^3 p_{i}x_i\\
    &=(0.3\times 1) +(0.6 \times 2) + (0.1 \times 3)\\
    &=0.3+1.2+0.3\\
    &=1.8
\end{align}
We know that variance($\sigma^2$) is 
\begin{align}
    \sigma^2 &= \sum_{i=1}^3 p_i x_i^2 -( \overline{x} ) ^2\\
    &= (0.3 \times 1^2) + (0.6 \times 2^2) +(0.1 \times 3^2) - 1.8^2\\
    &=(0.3) + (2.4) + (0.9) -3.24\\
    &= 0.36
\end{align}
